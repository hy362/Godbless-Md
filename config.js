...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://telegra.ph/file/5815088a3d657dc3b6fc6.jpg" ; // SET LOGO FOR IMAGE 



global.devs = "2347082604774" // Developer Contact
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "2347082604774";
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "2347082604774";
...
global.userImages= process.env.USER_IMAGES|| "https://telegra.ph/file/5815088a3d657dc3b6fc6.jpg",
...
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "2347082604774";
...
module.exports = {
  ...
  author: process.env.PACK_AUTHER || "It's 𝙂𝙊𝘿𝘽𝙇𝙀𝙎𝙎",
  packname: process.env.PACK_NAME || "It's 𝙂𝙊𝘿𝘽𝙇𝙀𝙎𝙎",
  botname : process.env.BOT_NAME  || "It's 𝙂𝙊𝘿𝘽𝙇𝙀𝙎𝙎",
  ownername:process.env.OWNER_NAME|| "✪𝙂𝙊𝘿𝘽𝙇𝙀𝙎𝙎-𝙈𝘿✪",
  ...
  LANG: process.env.THEME ? process.env.THEME.toUpperCase() : "✪𝙂𝙊𝘿𝘽𝙇𝙀𝙎𝙎-𝙈𝘿✪",
